...
export default class MainGrid extends Component {
  ...
  componentDidUpdate() {
    ...
    images
      .map((image) => image.parentNode)
      .filter((container) => !container.classList.contains("skeleton"))
      .map((container) => container.classList.add("skeleton"));
